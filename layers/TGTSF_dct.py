...
class text_encoder(nn.Module):
    def __init__(self, cross_layer=2, self_layer=3, embedding_dim=384, num_heads=8, dropout=0.0):
...
class TS_encoder(nn.Module): # 好像有问题.....
    ...
    def __init__(self, embedding_dim=384, num_heads=8, dropout=0.0, layers=3,
        ...
        self.W_pos = positional_encoding('sincos', True, (input_len-patch_len)//stride+1, embedding_dim)
    ...
    def forward(self, x):
        ...
        x = self.attentions(x, is_causal=self.causal, mask=attn_mask)
